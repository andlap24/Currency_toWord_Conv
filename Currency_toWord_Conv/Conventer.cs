...
namespace Currency_toWord_Conv
{
    class Conventer
    {
        ...
        private String changeToWords(String number, bool isCurrency)
        {
        ...
        private String translateWholeNumber(String number)
        {
            ...
            try
            {
                ...
                if (dblAmt > 0)
                {  //test for digit zero in a numeric
                    beginsZero = number.StartsWith("0");
                    int numDigits = number.Length;
                    int pos = 0;
                    String place = "";  //grouping name
                    switch (numDigits)
                    {
                        case 1:  //ones
                            word = ones(number);
